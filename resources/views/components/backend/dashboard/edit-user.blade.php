...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="container-fluid pt-3 p-4">
            <form class="mb-0" action="{{ route( 'dashboard.crud.put', [ 'namespace' => $crud[ 'namespace' ], 'id' =>   $user->id ] ) }}" enctype="multipart/form-data" method="post">
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        @each( 'partials.shared.fields', $Field->createUserFields( $user ), 'field' )
                    </div>
                    <div class="p-2 card-footer">
                        <button type="submit" class="mb-0 btn btn-raised btn-primary">{{ __( 'Update User' ) }}</button>
                    </div>
                </div>
            </form>
        </div>
